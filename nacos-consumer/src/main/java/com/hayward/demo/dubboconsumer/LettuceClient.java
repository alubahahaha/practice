...
public class LettuceClient {
    ...
    public static void operCluster(){
        ...
        list.add(RedisURI.create("redis://192.168.120.128:7002"));
        list.add(RedisURI.create("redis://192.168.120.128:7003"));
        list.add(RedisURI.create("redis://192.168.120.128:7004"));
        list.add(RedisURI.create("redis://192.168.120.128:7005"));
        list.add(RedisURI.create("redis://192.168.120.128:7006"));

//        list.add(RedisURI.create("redis://10.12.12.147:7800"));
//        list.add(RedisURI.create("redis://10.12.12.147:7801"));
//        list.add(RedisURI.create("redis://10.12.12.148:7800"));
//        list.add(RedisURI.create("redis://10.12.12.148:7801"));
//        list.add(RedisURI.create("redis://10.12.12.149:7800"));
//        list.add(RedisURI.create("redis://10.12.12.149:7801"));
